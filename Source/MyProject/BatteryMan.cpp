...
ABatteryMan::ABatteryMan()
{
	...
	GetCharacterMovement()->JumpZVelocity = 600.0f; //점프 초기 속도
	GetCharacterMovement()->AirControl = 0.2f; // 떨어질 때, 캐릭터에대한 측면 이동 제어 (0 = 제어없음 / 1 = MaxWalkSpeed의최대 값에서 완전한 제어)
...
void ABatteryMan::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Jump", IE_Pressed, this, &ACharacter::Jump); //눌렀을때
	PlayerInputComponent->BindAction("Jump", IE_Released, this, &ACharacter::StopJumping);//뗐을때
